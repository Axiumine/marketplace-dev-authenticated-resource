 ...
 *
 * The missing-header branch is the introspection bypass, which reaches a resolver with no session at all:
 * there is no caller to log out, so there is no key to delete.
 */
