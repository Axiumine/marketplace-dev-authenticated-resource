 ...
 *
 * ⚠️ **Nothing here configures TLS, and nothing here may.** Until the telemetry audit this file handed `Sentry.init`
 ...
 * arrival of a new one in a future release is caught by the version guard.
 *
