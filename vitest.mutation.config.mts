...
//     real dev MongoDB (plus clamd) hundreds of times — this service's own isolated
//     `marketplaceDev:itest:authenticatedResource:` namespace does not change that, since
